    ...
    physicalDevice{physicalDevice}
{
    ...
    if (std::find_if(requiredExtentions.begin(), requiredExtentions.end(), [](const char* ext) {return strcmp(VK_KHR_RAY_TRACING_PIPELINE_EXTENSION_NAME, ext) == 0; }) != requiredExtentions.end()) {
